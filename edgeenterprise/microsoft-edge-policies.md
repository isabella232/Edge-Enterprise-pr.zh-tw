...
```
  ...
  #### 設定 Microsoft Edge 新索引標籤頁面體驗 (已過時)
...
```
  ...
  #### 使用預設的查閱者原則 no-referrer-when-downgrade（已淘汰）
...
```
  ...
  #### 不对指向 _blank 的链接設定 window.opener

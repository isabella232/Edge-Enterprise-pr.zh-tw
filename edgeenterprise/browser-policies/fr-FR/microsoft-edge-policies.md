...
|||
|-|-|
|[Authentification HTTP](#authentification-http)|[投射](#cast)|
...
|[Serveur proxy](#serveur-proxy)|[其他](#additional)|
...
```
 ...
 Cette stratégie ne détermine pas la page qui s’ouvre au démarrage; cela est contrôlé par la stratégie [RestoreOnStartup](#restoreonstartup). Elle n’affecte pas non plus la page d’accueil si celle-ci est définie de manière à s'ouvrir dans le nouvel onglet.licy. 如果啟動頁面已設為開啟至新的索引標籤，則不會對首頁造成任何影響。
